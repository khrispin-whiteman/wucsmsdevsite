# Generated by Django 4.1.1 on 2022-12-16 22:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(max_length=200, verbose_name='Year')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_coordinator', models.ForeignKey(blank=True, max_length=200, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ProgramType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='schoolapp.level', verbose_name='Current Year Of Study')),
        ...
        migrations.AddField(
            model_name='program',
            name='program_type',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='schoolapp.programtype'),
        ),
        migrations.CreateModel(
            name='Department',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(blank=True, choices=[('FIRST', 'First'), ('SECOND', 'Second'), ('THIRD', 'Third')], max_length=10)),
                ('course_program', models.ForeignKey(help_text='Program to which the course belongs', on_delete=django.db.models.deletion.CASCADE, to='schoolapp.program', verbose_name='Program')),
                ('level', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='schoolapp.level', verbose_name='Year')),
            ],
        ),
        migrations.CreateModel(
            name='Admission',
            fields=[
                ...
                ('subject_english', models.CharField(blank=True, max_length=200, null=True, verbose_name='English')),
                ('subject_mathematics', models.CharField(blank=True, max_length=200, null=True, verbose_name='Mathematics')),
                ('subject_biology_human_and_social', models.CharField(blank=True, max_length=200, null=True, verbose_name='Biology/Human & Social')),
                ('subject_history', models.CharField(blank=True, max_length=200, null=True, verbose_name='History')),
                ('subject_religious_education', models.CharField(blank=True, max_length=200, null=True, verbose_name='Religious Education')),
                ('subject_commerce', models.CharField(blank=True, max_length=200, null=True, verbose_name='Commerce')),
                ('subject_home_economics', models.CharField(blank=True, max_length=200, null=True, verbose_name='Home Economics')),
                ('subject_geography', models.CharField(blank=True, max_length=200, null=True, verbose_name='Geography')),
                ('subject_physical_science', models.CharField(blank=True, max_length=200, null=True, verbose_name='Physical Science')),
                ('subject_chemistry', models.CharField(blank=True, max_length=200, null=True, verbose_name='Chemistry')),
                ('subject_physics', models.CharField(blank=True, max_length=200, null=True, verbose_name='Physics')),
                ('subject_civic_education', models.CharField(blank=True, max_length=200, null=True, verbose_name='Civic Education')),
                ...
                ('scanned_nrc', models.FileField(upload_to="id/deposits/%Y/%m/%d'")),
                ...
                ('application_status', models.CharField(choices=[('Pending', 'Pending'), ('Verified', 'Verified'), ('Approved', 'Approved'), ('Rejected', 'Rejected')], default='Pending Review', max_length=200, verbose_name='Application Status')),
                ('application_stage', models.CharField(choices=[('Admissions Office', 'Admissions Office'), ('Accounts Office', 'Accounts Office'), ('Dean Of Students Affairs Office', 'Dean Of Students Affairs Office'), ('ICT Office', 'ICT Office'), ('Program Coordinator or Principal Lecturer Office', 'Program Coordinator or Principal Lecturer Office'), ('Registrar Office', 'Registrar Office'), ('Other', 'Other')], default='Admissions Office', max_length=200, verbose_name='Application Stage')),
                ...
                ('intake', models.ForeignKey(blank=True, max_length=200, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='schoolapp.session', verbose_name='Intake')),
                ('program_applied_for', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='schoolapp.program', verbose_name='Program of Choice')),
                ('program_coordinator_or_principal_lecturer_office_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='program_coordinator_or_principal_lecturer_user', to=settings.AUTH_USER_MODEL)),
                ('registrar_office_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='registrar_office_user', to=settings.AUTH_USER_MODEL)),
                ('student_number', models.ForeignKey(default='', max_length=200, on_delete=django.db.models.deletion.CASCADE, to='schoolapp.studentnumber', verbose_name='Student Number')),
            ],
        ),
    ]
