# Generated by Django 4.1.1 on 2023-01-25 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca2', models.PositiveIntegerField(blank=True, default=0, null=True)),
        ...
        migrations.AddField(
            model_name='semester',
            name='session',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='schoolapp.session'),
        ),
        migrations.CreateModel(
            name='SchoolClass',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('Semester 1', 'Semester 1'), ('Semester 2', 'Semester 2')], max_length=100)),
        ...
        migrations.AddField(
            model_name='course',
            name='level',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='schoolapp.level', verbose_name='Year'),
        ),
        migrations.AddField(
            model_name='course',
            name='semester',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='schoolapp.semester'),
        ),
        migrations.CreateModel(
            name='Announcement',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(blank=True, max_length=200, null=True, verbose_name='DOB')),
