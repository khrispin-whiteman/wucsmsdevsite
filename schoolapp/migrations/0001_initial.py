# Generated by Django 4.1.1 on 2023-02-02 11:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_admission_details', models.ForeignKey(blank=True, help_text='search by student number', null=True, on_delete=django.db.models.deletion.SET_NULL, to='schoolapp.admission')),
                ('user', models.OneToOneField(help_text='search by student number', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='StudentNumber',
