...
urlpatterns = [
    ...
    path('applicationreport/<int:id>/',
         views.application_report,
         name='application_report'),
    # path('generatestudentno/', views.generateStudentNumber, name='generateStudentNumber'),
    path('generatestudentnorandomly/',
         views.generateStudentNumberRandomDigits,
         name='generateStudentNumberRandomDigits'),
    ...
    path('schools/<int:school_id>/programs/',
         views.school_details,
         name='school_details'),
    path('courses/', views.courses, name='courses'),
    path('online-admission/', views.online_admission, name='online-admission'),
    path('application-status/',
         views.templogintocheckapplicationstatus,
         name='templogintocheckapplicationstatus'),
    ...
    path('admin-admissions/',
         views.admin_admissions_list,
         name='admin_admissions_list'),
    path('admin-admissions/<int:admission_id>/',
         views.admin_admissions_detail,
         name='admin_admissions_detail'),
    path('update-online-application/<str:nrc_no>/',
         views.updateonlineapplication,
         name='updateonlineapplication'),
    path('admin-admissions/<int:admission_id>/approve/',
         views.admin_approve_application,
